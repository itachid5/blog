...
class Settings:
    ...
    session_reconnect_grace_seconds: int = int(os.getenv("SESSION_RECONNECT_GRACE_SECONDS", "300"))
    session_stale_seconds: int = int(os.getenv("SESSION_STALE_SECONDS", "600"))
    heartbeat_interval_seconds: int = int(os.getenv("HEARTBEAT_INTERVAL_SECONDS", "20"))
    heartbeat_misses_allowed: int = int(os.getenv("HEARTBEAT_MISSES_ALLOWED", "6"))
